...
from .views.index import IndexView, IndexSearchView, LikeView, visit_view, change_category_view, new_category_view, back_category_view, create_category_view, edit_category_view, delete_category_view, update_category_view
